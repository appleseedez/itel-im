...
#define SESSION_PERIOD_REFUSE_NOTIFICATION @"SESSION_PERIOD_REFUSE_NOTIFICATION" // 收到拒绝通话的响应  
...
#define SESSION_PERIOD_FIELD_ACTION_KEY @"action"
#define SESSION_PERIOD_FILED_ACTION_REFUSE @"refuse"
#define SESSION_PERIOD_FILED_ACTION_BUSY @"busy"
